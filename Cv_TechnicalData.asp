...
function canceledit() {
 ...
 window.location.href='cv_technicaldata.asp?itemid='+document.form1.itemID.value+'&edit=false';
}
function editmode() {
 //Put the page in edit mode.
 window.location.href='cv_technicaldata.asp?itemid='+document.form1.itemID.value+'&edit=true';
}
...
Dim body_material
Dim pallet_material
Dim diaphram_material
Dim flame_arrester
Dim arrester_material
Dim fluid_service
Dim fluid_state
Dim specific_gravity
Dim tank_capacity
Dim tank_capacity_units
Dim max_fill_rate
Dim max_fill_rate_units
Dim max_empty_rate
Dim max_empty_rate_units
Dim operating_press
Dim operating_press_units
Dim blanketed_tank
...
'			Response.Write "<body style='background-color:white' onload='window.print();window.close();'>"
	...
	If Request("itemID") <> "" Then
		...
		If Not rs.BOF Then
			...
			End If
			Response.Write "<tr>"
			Response.Write "<td style='text-align:left;vertical-align:top;font-size:12pt;font-weight:bold'>Conservation Vent - Technical Data Sheet</td>"
			...
			If Not rs.BOF Then
				...
				standard_job_plan = rs("standard_job_plan")
				...
				pallet_material = rs("pallet_material")
				diaphram_material = rs("diaphram_material")
				flame_arrester = rs("flame_arrester")
				arrester_material = rs("arrester_material")
				fluid_service = rs("fluid_service")
				fluid_state = rs("fluid_state")
				specific_gravity = rs("specific_gravity")
				tank_capacity = rs("tank_capacity")
				tank_capacity_units = rs("tank_capacity_units")
				max_fill_rate = rs("max_fill_rate")
				max_fill_rate_units = rs("max_fill_rate_units")
				max_empty_rate = rs("max_empty_rate")
				max_empty_rate_units = rs("max_empty_rate_units")
				operating_press = rs("operating_press")
				operating_press_units = rs("operating_press_units")
				blanketed_tank = rs("blanketed_tank")
			...
			Else
				...
				max_fill_rate_units = ""
				max_empty_rate = ""
				max_empty_rate_units = ""
				operating_press = ""
				operating_press_units = ""
				blanketed_tank = ""
				pressure_set_point = ""
				pressure_set_point_units = ""
				vacuum_set_point = ""
				vacuum_set_point_units = ""
				pad_set_point = ""
				pad_set_point_units = ""
				reg_gauge_range_from = ""
				reg_gauge_range_to = ""
				reg_gauge_range_units = ""
				arrester_manufacturer = ""
				arrester_model_number = ""
				arrester_serial_number = ""
				arrester_spec_number = ""
				code_stamp = ""
				drawing_number = ""
				inspection_standard = ""
			...
			End If
			Response.Write "<td id='techtd' style='width:20%'>Body Material:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
			...
			End If
			Response.Write "<td id='techtd'>Pallet Material:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='pallet_material' name='pallet_material' value='" & pallet_material & "' onchange='setupdate();' /></td>"
			Else
				Response.Write pallet_material & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Diaphram Matl:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='diaphram_material' name='diaphram_material' value='" & diaphram_material & "' onchange='setupdate();' /></td>"
			Else
				Response.Write diaphram_material & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Flame Arrester:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='flame_arrester' name='flame_arrester' value='" & flame_arrester & "' onchange='setupdate();' /></td>"
			Else
				Response.Write flame_arrester & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Arrester Matl:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='arrester_material' name='arrester_material' value='" & arrester_material & "' onchange='setupdate();' /></td>"
			Else
				Response.Write arrester_material & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Fluid In Vessel:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
			...
			End If
			Response.Write "<td id='techtd'>Tank Capacity:</td>"
			Response.Write "<td id='techtd' style='width:8%'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='tank_capacity' name='tank_capacity' value='" & tank_capacity & "' onchange='chkNumeric(this);setupdate();' /></td>"
			Else
				Response.Write tank_capacity & "</td>"
			End If
			Response.Write "<td id='techtd' colspan='3'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:80%' id=tank_capacity_units' name='tank_capacity_units' value='" & tank_capacity_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write tank_capacity_units & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Max Fill Rate:</td>"
			Response.Write "<td id='techtd'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='max_fill_rate' name='max_fill_rate' value='" & max_fill_rate & "' onchange='chkNumeric(this);setupdate();' /></td>"
			Else
				Response.Write max_fill_rate & "</td>"
			End If
			Response.Write "<td id='techtd' colspan='3'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:80%' id='max_fill_rate_units' name='max_fill_rate_units' value='" & max_fill_rate_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write max_fill_rate_units & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			Response.Write "<td id='techtd'>Inlet Size:</td>"
			Response.Write "<td id='techtd'>"
			If editMode = True Then
			...
			Response.Write "<td id='techtd'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:75%' id='in_connect_size_units' name='in_connect_size_units' value='" & in_connect_size_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write in_connect_size_units & "</td>"
			End If
			Response.Write "<td id='techtd'>Max Empty Rate:</td>"
			Response.Write "<td id='techtd'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='max_empty_rate' name='max_empty_rate' value='" & max_empty_rate & "' onchange='chkNumeric(this);setupdate();' /></td>"
			Else
				Response.Write max_empty_rate & "</td>"
			End If
			Response.Write "<td id='techtd' colspan='3'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:80%' id='max_empty_rate_units' name='max_empty_rate_units' value='" & max_empty_rate_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write max_empty_rate_units & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			Response.Write "<td id='techtd'>Inlet Type:</td>"
			Response.Write "<td id='techtd' colspan='2'>"
			If editMode = True Then
			...
			End If
			Response.Write "<td id='techtd'>Operating Press:</td>"
			Response.Write "<td id='techtd'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='operating_press' name='operating_press' value='" & operating_press & "' onchange='chkNumeric(this);setupdate();' /></td>"
			Else
				Response.Write operating_press & "</td>"
			End If
			Response.Write "<td id='techtd' colspan='3'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:80%' id='operating_press_units' name='operating_press_units' value='" & operating_press_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write operating_press_units & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			Response.Write "<td id='techtd'>Outlet Size:</td>"
			Response.Write "<td id='techtd'>"
			If editMode = True Then
			...
			Response.Write "<td id='techtd'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:75%' id='out_connect_size_units' name='out_connect_size_units' value='" & out_connect_size_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write out_connect_size_units & "</td>"
			End If
			Response.Write "<td id='techtd'>Blanketed Tank:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='blanketed_tank' name='blanketed_tank' value='" & blanketed_tank & "' onchange='setupdate();' /></td>"
			Else
				Response.Write blanketed_tank & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			Response.Write "<td id='techtd'>Outlet Type:</td>"
			Response.Write "<td id='techtd' colspan='2'>"
			If editMode = True Then
			...
			Response.Write "<td id='techtd'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='pressure_set_point' name='pressure_set_point' value='" & pressure_set_point & "' onchange='chkNumeric(this);setupdate();' /></td>"
			Else
				Response.Write pressure_set_point & "</td>"
			End If
			Response.Write "<td id='techtd' colspan='3'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:80%' id='pressure_set_point_units' name='pressure_set_point_units' value='" & pressure_set_point_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write pressure_set_point_units & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			Response.Write "<td id='techtd'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='vacuum_set_point' name='vacuum_set_point' value='" & vacuum_set_point & "' onchange='chkNumeric(this);setupdate();' /></td>"
			Else
				Response.Write vacuum_set_point & "</td>"
			End If
			Response.Write "<td id='techtd' colspan='3'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:80%' id='vacuum_set_point_units' name='vacuum_set_point_units' value='" & vacuum_set_point_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write vacuum_set_point_units & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			Response.Write "<td id='techtd'>Standard Job Plan:</td>"
			Response.Write "<td id='techtd' colspan='2'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='standard_job_plan' name='standard_job_plan' value='" & standard_job_plan & "' onchange='setupdate();' /></td>"
			Else
				Response.Write standard_job_plan & "</td>"
			End If
			Response.Write "<td id='techtd'>Pad Set Point:</td>"
			Response.Write "<td id='techtd'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='pad_set_point' name='pad_set_point' value='" & pad_set_point & "' onchange='chkNumeric(this);setupdate();' /></td>"
			Else
				Response.Write pad_set_point & "</td>"
			End If
			Response.Write "<td id='techtd' colspan='3'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:80%' id='pad_set_point_units' name='pad_set_point_units' value='" & pad_set_point_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write pad_set_point_units & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Reg Gauge Range:</td>"
			Response.Write "<td id='techtd'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='reg_gauge_range_from' name='reg_gauge_range_from' value='" & reg_gauge_range_from & "' onchange='chkNumeric(this);setupdate();' /></td>"
			Else
				Response.Write reg_gauge_range_from & "</td>"
			End If
			Response.Write "<td id='techtd' style='width:1%;text-align:center'>to</td>"
			Response.Write "<td id='techtd' style='width:8%'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='reg_gauge_range_to' name='reg_gauge_range_to' value='" & reg_gauge_range_to & "' onchange='chkNumeric(this);setupdate();' /></td>"
			Else
				Response.Write reg_gauge_range_to & "</td>"
			End If
			Response.Write "<td id='techtd' style='width:13%'>"
			If editMode = True Then
				Response.Write "(units) <input type='text' class='text' style='width:60%' id='reg_gauge_range_units' name='reg_gauge_range_units' value='" & reg_gauge_range_units & "' onchange='setupdate();' /></td>"
			Else
				Response.Write reg_gauge_range_units & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Arrester Manufacturer:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='arrester_manufacturer' name='arrester_manufacturer' value='" & arrester_manufacturer & "' onchange='setupdate();' /></td>"
			Else
				Response.Write arrester_manufacturer & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Arrester Model No:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='arrester_model_number' name='arrester_model_number' value='" & arrester_model_number & "' onchange='setupdate();' /></td>"
			Else
				Response.Write arrester_model_number & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Arrester Serial No:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='arrester_serial_number' name='arrester_serial_number' value='" & arrester_serial_number & "' onchange='setupdate();' /></td>"
			Else
				Response.Write arrester_serial_number & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Arrester Spec No:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='arrester_spec_number' name='arrester_spec_number' value='" & arrester_spec_number & "' onchange='setupdate();' /></td>"
			Else
				Response.Write arrester_spec_number & "</td>"
			End If
			Response.Write "</tr>"
			Response.Write "<tr>"
			...
			End If
			Response.Write "<td id='techtd'>Code Stamp:</td>"
			Response.Write "<td id='techtd' colspan='4'>"
			If editMode = True Then
				Response.Write "<input type='text' class='text' style='width:100%' id='code_stamp' name='code_stamp' value='" & code_stamp & "' onchange='setupdate();' /></td>"
			Else
			...
			Response.Write "<tr>"
			Response.Write "<td id='techtd colspan='8'>&nbsp;</td>"
			Response.Write "</tr>"
			If editMode = True Then
				Response.Write "<tr>"
				...
				Response.Write "<td id='techtd' colspan='5' style='text-align:left'>"
			...
			ElseIf access = "write" Or access = "delete" Then
				Response.Write "<tr>"
				Response.Write "<td id='techtd' colspan='8' style='text-align:center'>"
